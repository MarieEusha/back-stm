 ...
 */
final class Version20201001201357 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE encounter (id INT AUTO_INCREMENT NOT NULL, team_id INT NOT NULL, tactic_id INT NOT NULL, date DATE NOT NULL, label_opposing_team VARCHAR(75) NOT NULL, category_opposing_team VARCHAR(50) NOT NULL, INDEX IDX_69D229CA296CD8AE (team_id), INDEX IDX_69D229CA595B6E0E (tactic_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE player (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, team_id INT DEFAULT NULL, picture VARCHAR(255) NOT NULL, height INT NOT NULL, weight DOUBLE PRECISION NOT NULL, injured TINYINT(1) NOT NULL, INDEX IDX_98197A65A76ED395 (user_id), INDEX IDX_98197A65296CD8AE (team_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE stats (id INT AUTO_INCREMENT NOT NULL, encounter_id INT NOT NULL, player_id INT NOT NULL, redcard INT NOT NULL, yellow_card INT NOT NULL, pass_assist INT NOT NULL, goal INT NOT NULL, INDEX IDX_574767AAD6E2FADC (encounter_id), INDEX IDX_574767AA99E6F5DF (player_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tactic (id INT AUTO_INCREMENT NOT NULL, team_id INT NOT NULL, pos1_id INT NOT NULL, pos2_id INT NOT NULL, pos3_id INT NOT NULL, pos4_id INT NOT NULL, pos5_id INT NOT NULL, pos6_id INT NOT NULL, pos7_id INT NOT NULL, pos8_id INT NOT NULL, pos9_id INT NOT NULL, pos10_id INT NOT NULL, pos11_id INT NOT NULL, type VARCHAR(50) NOT NULL, INDEX IDX_9FCCC8E4296CD8AE (team_id), INDEX IDX_9FCCC8E4E743AB23 (pos1_id), INDEX IDX_9FCCC8E4F5F604CD (pos2_id), INDEX IDX_9FCCC8E44D4A63A8 (pos3_id), INDEX IDX_9FCCC8E4D09D5B11 (pos4_id), INDEX IDX_9FCCC8E468213C74 (pos5_id), INDEX IDX_9FCCC8E47A94939A (pos6_id), INDEX IDX_9FCCC8E4C228F4FF (pos7_id), INDEX IDX_9FCCC8E49A4BE4A9 (pos8_id), INDEX IDX_9FCCC8E422F783CC (pos9_id), INDEX IDX_9FCCC8E4CC50782F (pos10_id), INDEX IDX_9FCCC8E474EC1F4A (pos11_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE training_missed (id INT AUTO_INCREMENT NOT NULL, training_id INT NOT NULL, player_id INT NOT NULL, INDEX IDX_DF0E8CACBEFD98D1 (training_id), INDEX IDX_DF0E8CAC99E6F5DF (player_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, club_id INT NOT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, last_name VARCHAR(75) NOT NULL, first_name VARCHAR(75) NOT NULL, birthday DATE NOT NULL, phone VARCHAR(15) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D64961190A32 (club_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE encounter ADD CONSTRAINT FK_69D229CA595B6E0E FOREIGN KEY (tactic_id) REFERENCES tactic (id)');
        $this->addSql('ALTER TABLE player ADD CONSTRAINT FK_98197A65A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE player ADD CONSTRAINT FK_98197A65296CD8AE FOREIGN KEY (team_id) REFERENCES team (id)');
        $this->addSql('ALTER TABLE stats ADD CONSTRAINT FK_574767AAD6E2FADC FOREIGN KEY (encounter_id) REFERENCES encounter (id)');
        $this->addSql('ALTER TABLE stats ADD CONSTRAINT FK_574767AA99E6F5DF FOREIGN KEY (player_id) REFERENCES player (id)');
        $this->addSql('ALTER TABLE tactic ADD CONSTRAINT FK_9FCCC8E4296CD8AE FOREIGN KEY (team_id) REFERENCES team (id)');
        $this->addSql('ALTER TABLE tactic ADD CONSTRAINT FK_9FCCC8E4E743AB23 FOREIGN KEY (pos1_id) REFERENCES player (id)');
        $this->addSql('ALTER TABLE tactic ADD CONSTRAINT FK_9FCCC8E4F5F604CD FOREIGN KEY (pos2_id) REFERENCES player (id)');
        $this->addSql('ALTER TABLE tactic ADD CONSTRAINT FK_9FCCC8E44D4A63A8 FOREIGN KEY (pos3_id) REFERENCES player (id)');
        $this->addSql('ALTER TABLE tactic ADD CONSTRAINT FK_9FCCC8E4D09D5B11 FOREIGN KEY (pos4_id) REFERENCES player (id)');
        $this->addSql('ALTER TABLE tactic ADD CONSTRAINT FK_9FCCC8E468213C74 FOREIGN KEY (pos5_id) REFERENCES player (id)');
        $this->addSql('ALTER TABLE tactic ADD CONSTRAINT FK_9FCCC8E47A94939A FOREIGN KEY (pos6_id) REFERENCES player (id)');
        $this->addSql('ALTER TABLE tactic ADD CONSTRAINT FK_9FCCC8E4C228F4FF FOREIGN KEY (pos7_id) REFERENCES player (id)');
        $this->addSql('ALTER TABLE tactic ADD CONSTRAINT FK_9FCCC8E49A4BE4A9 FOREIGN KEY (pos8_id) REFERENCES player (id)');
        $this->addSql('ALTER TABLE tactic ADD CONSTRAINT FK_9FCCC8E422F783CC FOREIGN KEY (pos9_id) REFERENCES player (id)');
        $this->addSql('ALTER TABLE tactic ADD CONSTRAINT FK_9FCCC8E4CC50782F FOREIGN KEY (pos10_id) REFERENCES player (id)');
        $this->addSql('ALTER TABLE tactic ADD CONSTRAINT FK_9FCCC8E474EC1F4A FOREIGN KEY (pos11_id) REFERENCES player (id)');
        ...
        $this->addSql('ALTER TABLE training_missed ADD CONSTRAINT FK_DF0E8CACBEFD98D1 FOREIGN KEY (training_id) REFERENCES training (id)');
        $this->addSql('ALTER TABLE training_missed ADD CONSTRAINT FK_DF0E8CAC99E6F5DF FOREIGN KEY (player_id) REFERENCES player (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE encounter DROP FOREIGN KEY FK_69D229CA595B6E0E');
